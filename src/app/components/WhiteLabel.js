      ...
      <section className=" mt-28 mx-auto ">
        <div className=" mx-auto text-center">
          ...
          <h1 className="text-[2.25rem]  font-semibold text-[#000000] mb-7 leading-tight max-w-[50rem] mx-auto">
            White Label App Solutions <br></br> for Various Industries
          </h1>

          {/* Description Paragraphs */}
          <div className="w-[60.25rem] font-normal mx-auto mb-[2.25rem] text-justify space-y-[1.5rem]">
        ...
        <div className="w-[60.43rem] mx-auto mb-20">
          <p className="font-medium text-[1rem] text-[#000000] tracking-normal ">
        ...
        <div
          className="w-[42.75rem] mx-auto mb-[3.75rem] rounded-[0.75rem] bg-[#FFFFFF] p-5  shadow-lg"
          style={{
            boxShadow: `
                     1px 1px 4px rgba(0, 0, 0, 0.2), 8px 8px 18px rgba(0, 0, 0, 0.1)`,
          }}
        >
          <p className=" w-[40.25rem] text-center font-medium text-2xl tracking-normal text-[#2F2175]">
        ...
        <div className="max-w-[72.5rem] mx-auto ">
          <div className="flex flex-wrap justify-center gap-6">
            {[
              ...
              <div
                key={idx}
                className="bg-white rounded-[1.25rem] px-6 py-5 w-[35rem] flex flex-col "
                style={{
                  boxShadow:
                    "1px 1px 4px rgba(0, 0, 0, 0.1), 4px 4px 12px rgba(0, 0, 0, 0.1)",
                }}
              >
                <div className="relative w-[31.25rem] mb-[1.125rem] h-[22.187rem]">
                  <Image
